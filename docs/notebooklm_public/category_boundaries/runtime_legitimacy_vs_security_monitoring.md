...
Overlap: both can consume context and policy signals.
Separation: monitoring is primarily post-fact awareness; legitimacy is pre-mutation authority correctness.
